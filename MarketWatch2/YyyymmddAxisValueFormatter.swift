//
//  Yyyy-mm-ddAxisValueFormatter.swift
//  MarketWatch2
//
//  Created by vincent schmitt on 31/03/2021.
//

import Foundation
import Charts

public class YyyymmddAxisValueFormatter: NSObject, AxisValueFormatter {
    weak var chart: BarLineChartViewBase?
    var dayIndex: [String]
    //let months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    
    init(chart: BarLineChartViewBase, dayIndex: [String]) {
        self.chart = chart
        self.dayIndex = dayIndex
    }
    
    public func stringForValue(_ value: Double, axis: AxisBase?) -> String {
        let dayNum = Int(value)
        if dayNum >= 0 && dayNum < dayIndex.count {
